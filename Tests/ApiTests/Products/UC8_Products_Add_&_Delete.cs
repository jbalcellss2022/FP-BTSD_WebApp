...
namespace Tests.ApiTests.Products
{
    ...
    internal class UC8_CreateProduct : BaseTest
    {
        ...
        /********* UC8 **************************************************************/
        /****************************************************************************/
        //Use Case:         Authenticate User and Create Product via QRFY API
        //Use Case Name:    Authenticate User and Create Product
        //Description:      This use case describes the steps required for a user to authenticate via the QRFY API and subsequently create a product associated with their account.
        //Actors:
        ...
        //      The QRFY API creates the product and returns its details to the authenticated user.
