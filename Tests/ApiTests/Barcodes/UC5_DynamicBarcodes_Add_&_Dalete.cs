...
namespace Tests.ApiTests.Barcodes
{
    ...
    internal class UC5_CreateDynamicBarcode : BaseTest
    {
        ...
        /********* UC5 **************************************************************/
        /****************************************************************************/
        //Use Case:         Authenticate User and Create Dynamic Barcode via QRFY API
        //Use Case Name:    Authenticate User and Create Dynamic Barcode
        //Description:      This use case describes the steps required for a user to authenticate via the QRFY API and subsequently create a dynamic barcode associated with their account.
        //Actors:
        ...
        //      The QRFY API creates the dynamic barcode and returns its details to the authenticated user.
