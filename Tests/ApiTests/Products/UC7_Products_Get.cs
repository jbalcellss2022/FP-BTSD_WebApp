...
namespace Tests.ApiTests.Products
{
    ...
    internal class UC7_GetAllProducts : BaseTest
    {
        ...
        /********* UC7 **************************************************************/
        /****************************************************************************/
        //Use Case:         Authenticate User and Retrieve All Products via QRFY API
        //Use Case Name:    Authenticate User and Retrieve All Products
        //Description:      This use case describes the steps required for a user to authenticate via the QRFY API and subsequently retrieve all products associated with their account.
        //Actors:
        ...
        //  The user has an account with the QRFY service that includes at least one product.
        //Postconditions:
        ...
        //      The QRFY API returns a list of all products associated with the authenticated user's account.
        //Extensions (Alternate Flows):
        //  Invalid Credentials:
        //      If the user provides invalid credentials, the QRFY API returns an authentication error message (401, "Unauthorized").
        //      The user cannot retrieve data from the QRFY API.
