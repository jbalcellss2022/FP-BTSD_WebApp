...
namespace ExternalAPI.Controllers
{
        ...
        ) : ControllerBase
    {
        ...
        [SwaggerOperation(Description = "Retrieve all products associated with QRFY user. The result will be a JSON list with the available products and their attributes.<br /><br />" +
