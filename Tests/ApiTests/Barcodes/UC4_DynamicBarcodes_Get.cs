...
namespace Tests.ApiTests.Barcodes
{
    ...
    internal class UC4_GetAllDynamicBarcode : BaseTest
    {
        ...
        /********* UC4 **************************************************************/
        /****************************************************************************/
        //Use Case:         Authenticate User and Retrieve All Dynamic Barcodes via QRFY API
        //Use Case Name:    Authenticate User and Retrieve All Dynamic Barcodes
        //Description:      This use case describes the steps required for a user to authenticate via the QRFY API and subsequently retrieve all dynamic barcodes associated with their account.
        //Actors:
        ...
        //  The user has an account with the QRFY service that includes at least one dynamic barcode.
        //Postconditions:
        ...
        //      The QRFY API returns a list of all dynamic barcodes associated with the authenticated user's account.
        //Extensions (Alternate Flows):
        //  Invalid Credentials:
        //      If the user provides invalid credentials, the QRFY API returns an authentication error message (401, "Unauthorized").
        //      The user can not retrieve data from the QRFY API.
