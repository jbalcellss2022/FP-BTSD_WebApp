...
namespace Tests.ApiTests.Barcodes
{
    ...
    internal class UC3_UpdateStaticBarcode : BaseTest
    {
        ...
        /********* UC3 **************************************************************/
        /****************************************************************************/
        //Use Case:         Authenticate User and Update Static Barcode via QRFY API
        //Use Case Name:    Authenticate User and Update Static Barcode
        //Description:      This use case describes the steps required for a user to authenticate via the QRFY API and subsequently update a static barcode associated with their account.
        //Actors:
        ...
        //      The QRFY API updates the static barcode and returns its details to the authenticated user.
