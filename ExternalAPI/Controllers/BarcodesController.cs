...
namespace ExternalAPI.Controllers
{
        ...
        ) : ControllerBase
    {
        ...
        [SwaggerOperation(Description = "This endpoint allows clients to fetch a comprehensive list of all static barcodes created by a QRFY user. Static barcodes are pre-generated barcodes that do not change and can be used for various purposes such as product identification, tracking, and more. This endpoint provides an efficient way to access all static barcode information in one request. <br/><br/>" +
        ...
        /// <response code="422">Unprocessable Entity. Unexpected API error.</response>
        /// <response code="429">Too Many Requests. The application has exceeded the API rate limit.</response>
        [SwaggerOperation(Description = "This endpoint allows clients to fetch a comprehensive list of all dynamic barcodes created by a QRFY user. " +
