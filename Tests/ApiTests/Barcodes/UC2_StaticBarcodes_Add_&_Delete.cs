...
namespace Tests.ApiTests.Barcodes
{
    ...
    internal class UC2_CreateStaticBarcode : BaseTest
    {
        ...
        /********* UC2 **************************************************************/
        /****************************************************************************/
        //Use Case:         Authenticate User and Create Static Barcode via QRFY API
        //Use Case Name:    Authenticate User and Create Static Barcode
        //Description:      This use case describes the steps required for a user to authenticate via the QRFY API and subsequently create a static barcode associated with their account.
        //Actors:
        ...
        //      The QRFY API creates the static barcode and returns its details to the authenticated user.
