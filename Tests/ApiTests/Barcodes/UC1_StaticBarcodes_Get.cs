...
namespace Tests.ApiTests.Barcodes
{
    ...
    internal class UC1_GetAllStaticBarcode : BaseTest
    {
        ...
        /********* UC1 **************************************************************/
        /****************************************************************************/
        //Use Case:         Authenticate User and Retrieve All Static Barcodes via QRFY API
        //Use Case Name:    Authenticate User and Retrieve All Static Barcodes
        //Description:      This use case describes the steps required for a user to authenticate via the QRFY API and subsequently retrieve all static barcodes associated with their account.
        //Actors:
        ...
        //  The user has an account with the QRFY service that includes at least one static barcode.
        //Postconditions:
        ...
        //      The QRFY API returns a list of all static barcodes associated with the authenticated user's account.
