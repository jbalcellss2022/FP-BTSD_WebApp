...
namespace Tests.ApiTests.Products
{
    ...
    internal class UC9_UpdateProduct : BaseTest
    {
        ...
        /********* UC9 **************************************************************/
        /****************************************************************************/
        //Use Case:         Authenticate User and Update Product via QRFY API
        //Use Case Name:    Authenticate User and Update Product
        //Description:      This use case describes the steps required for a user to authenticate via the QRFY API and subsequently update a product associated with their account.
        //Actors:
        ...
        //      The QRFY API updates the product and returns its details to the authenticated user.
